                ...
                <div class="card card-info card-outline">
                    ...
                    <div class="d-flex justify-content-around">
                        ...
                        @if (Auth::user()->detail_data == null)
                            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#detail">Add
                                detail</a>
                        @else
    ...
    <div class="modal fade" id="image">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="/profile42/edit/image/{{ Auth::user()->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
    ...
    <div class="modal fade" id="password">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="/profile42/edit/password/{{ Auth::user()->id }}" method="post">
                    @csrf
                    @method('put')
                    <div class="modal-body">
                        <div class="mb-3">
    ...
    <div class="modal fade" id="detail">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="/detaildata42" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
        ...
        <div class="modal fade" id="updatedetail">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="/detaildata42/{{ Auth::user()->id }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="modal-body">
                            <div class="mb-3">
